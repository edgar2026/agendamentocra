...
import { ArchiveHistorico } from "@/components/admin/ArchiveHistorico"; // Importar o novo componente
...
const AdminPanel = () => {
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-2xl font-bold tracking-tight mb-2">Gerenciamento de Dados</h2>
