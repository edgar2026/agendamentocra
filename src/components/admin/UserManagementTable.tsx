...
const RoleBadge = ({ role }: { role: UserRole }) => {
    const variant = {
        ...
        ATENDENTE: "secondary",
        TRIAGEM: "default",
        DESENVOLVEDOR: "outline", // Adicionado estilo para DESENVOLVEDOR
    ...
    const roleText = {
        ...
        ATENDENTE: "Atendente",
        TRIAGEM: "Triagem",
        DESENVOLVEDOR: "Desenvolvedor", // Adicionado texto para DESENVOLVEDOR
    }[role];
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuPortal>
                  <DropdownMenuSubContent>
                    <DropdownMenuItem onClick={() => updateUserRoleMutation.mutate({ userId: profile.id, role: 'DESENVOLVEDOR' })}>
